...
if(isset($_SESSION["superAdminLoggedin"]) && $_SESSION["superAdminLoggedin"] === true){
    header("location: superAdminWelcome.php");
    exit;
}
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT id, username, password FROM superAdmin WHERE username = ?";
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){
                    ...
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password)){
                            ...
                            $_SESSION["superAdminLoggedinId"] = $id;
                            $_SESSION["superAdminLoggedinUsername"] = $username;
...
<head>
	<title>EEKI Foods Super Admin Login</title>
...
The objective is achieved by setting up farms with a farm-partner across on outskirts of major urban areas of India. These farms produce high-quality residue-free fruits and vegetables using our IOT enabled completely medium-less growing technology. “We are not consultants. We are growers, the technology enablers.”</p>
				...
				<div class="form-left">
					<div class="middle">
						...
						<p>Login here to administer your Admins</p>
					</div>
              ...
              <!-- <span style="float:right;"><a href="reset-admin.php">Forgot Password?</a></span> -->
					</form>
